...
class Page
{
	...
	public function show()
	{
		...
		if ($upRow > 0) {
			$upPage = '<li class="paginItem"><a href="' . str_replace('%page%', $upRow, $url) . '"><span class="pagepre"><i class="fa fa-angle-left"></i>' . $this->config ['prev'] . '</span></a></li>';
		} else {
			$upPage = '';
		}

		if ($downRow <= $this->totalPages) {
			$downPage = '<li class="paginItem"><a href="' . str_replace('%page%', $downRow, $url) . '"><span class="pagenxt"><i class="fa fa-angle-right"></i>' . $this->config ['next'] . '</span></a></li>';
		} else {
			$downPage = '';
		}
		// << < > >>
