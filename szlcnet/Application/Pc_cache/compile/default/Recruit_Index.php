	...
	$(".tab").click(function(){
		 layer.open({
	     	...
	     	skin: 'layui-layer-rim', //加上边框
	  		...
	  		content:"<?php echo $APP_URL;?>Recruit/detail/id/"+$(this).attr("data-id")
		});
	})
})
...
<div class="recruit_list">
  <ul>
    <li style="background:#018ae1;" class="top">
      <table border="0">
        <tr >
          <td width="280">招聘岗位</td>
          <td width="275">招聘人数</td>
          <td width="270">工作地点</td>
          <td width="170">薪资</td>
          <td width="230">发布日期</td>
        </tr>
      </table>
    </li>
    ...
    <?php if(is_array($list)){foreach($list as $key=>$vo){?>
      <li>
        <table border="0">
          <tr class="tab" data-id="<?php echo $vo['id'];?>">
            <td width="280"><?php echo $vo['job'];?></td>
            <td width="275"><?php echo $vo['recruitment_num'];?></td>
            <td width="270"><?php echo $vo['address'];?></td>
            <td width="170"><?php echo $vo['salary'];?></td>
            <td width="230"><?php dateFormat($vo['sart_time']); ?></td>
          </tr>
        </table>
      </li>
    <?php } } ?>
