...
<div class="pageNews">
  <div class="newsDetailed"> <?php echo $detail['news_content'];?> </div>
  <div class="newsPage">
    <dl>
      <dt>
        <p>上一篇
          <?php if($prev==null){ ?><a class="prev_a selected " href="javascript:;">没有了</a>
            <?php }else{ ?>
            <a  href="<?php echo $APP_URL;?>News/detail/id/<?php echo $prev;?>.html">上一条记录</a> <?php } ?>
        </p>
        <p>下一篇:
          <?php if($next==null){ ?><a href="javascript:;">没有了</a>
            <?php }else{ ?>
            <a  href="<?php echo $APP_URL;?>News/detail/id/<?php echo $next;?>.html">上一条记录</a> <?php } ?>
        </p>
      </dt>
