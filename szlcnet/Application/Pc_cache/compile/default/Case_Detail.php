...
<script src="<?php echo $OSS_URL;?>js/layer/layer.js" type="text/javascript"></script>
    ...
    <link rel="stylesheet" href="<?php echo $OSS_URL;?>css/font-awesome.css"/>
    <link rel="stylesheet" href="<?php echo $OSS_URL;?>css/Case.css"/>
    <script src="<?php echo $OSS_URL;?>js/jquery.lazyload.js" type="text/javascript"></script>
</head>
<body>
﻿<header id="header">
  <div class="headDiv">
...
<div class="detail_banner detail_case_banner">
    <h2 class="banz">发现你的不同，让品牌脱颖而出</h2>

    <p><a href="<?php echo $APP_URL;?>Marketing/Index#guestBook">我也想做这样的WEBSITE网站</a><a href="<?php echo $APP_URL;?>Case/index"
                                                                            class="yellow"><i
            class="fa fa-angle-double-left"></i>&nbsp;返回案例首页</a></p>
</div>
<div class="case_info case_info_banbox" style="position:relative;">
    <div class="left" id="left_mm">
        <div class="con">
            <div class="title"> <?php echo $case_detail['case_name'];?> <span></span></div>
            <div class="txt">
                <p> <?php echo $case_detail['case_content'];?></p>
            </div>
            <?php if($morderImg==true){ ?>
                <script src="<?php echo $OSS_URL;?>js/Case_brower.js" type="text/javascript"></script>
                <div class="intense_img">
                    <h1><i class="fa fa-th-large"></i>网站部分设计图<span>(点击可进入全屏浏览)</span></h1>
                    <ul>
                        <?php if(is_array($spicArr)){foreach($spicArr as $k=>$vo){?>
                            <li class="demo-image first" data-image="<?php echo $APP_URL;?><?php echo $vo;?>"
                                data-title="<?php echo $case_detail['case_name'];?>" data-caption="<?php echo $case_detail['case_des'];?>"><img
                                    src="<?php echo $OSS_URL;?><?php echo $vo;?>"/></li>
                        <?php } } ?>
                    </ul>
                </div>
                <script type="text/javascript">
    ...
    <div class="conten" style="left: 34.8%;">
        <div class="con"><span class="pc span"></span> <!--<span class="mobile"></span>--></div>
    </div>
    <div class="right" style="  width:71%; position:relative; left:34.8%; top:0;">
        <div class="tab">
            <?php if($prev==null){ ?><a style="cursor:not-allowed; background:#707070;" title="没有啦" class="prev "
                                           href="javascript:;"><i class="fa fa-arrow-left fa-2x"></i></a>
                <?php }else{ ?>
                    <a class="prev" href="<?php echo $APP_URL;?>Case/detail/id/<?php echo $prev;?>.html"><i class="fa fa-arrow-left fa-2x"></i>
                    </a>
            <?php } ?>
            <?php if($next==null){ ?><a class="next" style="cursor:not-allowed; background:#707070;" title="没有啦"
                                           class="prev " href="javascript:;"><i class="fa fa-arrow-right fa-2x"></i></a>
                <?php }else{ ?>
                    <a  class="next" href="<?php echo $APP_URL;?>Case/detail/id/<?php echo $next;?>.html"><i class="fa fa-arrow-right fa-2x"></i>
                    </a>
            <?php } ?>
        </div>
        <img data-original="<?php echo $OSS_URL;?><?php echo $spic;?>" id="fadeInImg"/></div>
</div>
		...
		$(window).scroll(function(){  
		  ...
		  if(top>=m){
			  $("#left_mm").css({
				 ...
				 $(".foot_tl").css("position","relative");
		  }else{
			   $("#left_mm").removeAttr("style");
