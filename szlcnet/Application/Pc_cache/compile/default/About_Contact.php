...
<link rel="stylesheet" href="<?php echo $OSS_URL;?>css/Contact.css"/>
...
<div class="qing abo-gy">
  <div class="abo-gy-ti0">
    <table border="0" cellpadding="0" cellspacing="0">
      <tbody>
        <tr>
          <td><?php if(is_array($aboutList)){foreach($aboutList as $key=>$about){?> <a href="<?php echo $APP_URL;?><?php echo $about['url'];?>" 
              
              <?php if($about['basic_id']==$current_about_id){ ?>class="abonn"
                <?php }else{ ?>
                class="abott1"<?php } ?>
              ><span class="abott1"><?php echo $about['basic_name'];?></span><span class="abott2"><?php echo $about['basic_name'];?></span></a> <?php } } ?></td>
        </tr>
      </tbody>
    </table>
  </div>
  <div class="abo-gy-kk" style=" margin-top:50px;">
      <div class="contacth3"><span>联系我们</span> <em>CONTACT US</em></div>
      <div class="contact_con">
          <div class="contact_top">
              <h3><span style="float: left;">全国客户服务电话：<span>400-186-9596</span></span><span style="float: right;">企业邮箱：<span>mail@szlcnet.com</span></span></h3>
          </div>
          <div class="contact_lxfs">
              <div class="contact_lxfs_1">
                  <div class="contact_lxfs_con_l">
                      <span class="span1"><img src="<?php echo $OSS_URL;?>img/yw.png"/></span>
                      <span class="span2">
                          <h3>业务咨询</h3>
                          Tel:134 2131 4035&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;0755-33059400<br />
                          QQ:427011939&nbsp;&nbsp;<a href="http://wpa.qq.com/msgrd?v=3&uin=427011939&site=qq&menu=yes" target="_blank"><img src="<?php echo $OSS_URL;?>img/QQzx.jpg"/></a><br />
                          E-mail:shiliu@szlcnet.com&nbsp;&nbsp;&nbsp;联系人:张小姐
                      </span>
                  </div>
                  <div class="contact_lxfs_con_l float_r">
                      <span class="span1"><img src="<?php echo $OSS_URL;?>img/js.png"/></span>
                      <span class="span2">
                          <h3>技术支持</h3>
                          Tel:135 3810 0855&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;0755-33059400<br />
                          QQ:1109186819&nbsp;&nbsp;<a href="http://wpa.qq.com/msgrd?v=3&uin=1109186819&site=qq&menu=yes" target="_blank"><img src="<?php echo $OSS_URL;?>img/QQzx.jpg"/></a><br />
                          E-mail:info@szlcnet.com&nbsp;&nbsp;&nbsp;联系人:李先生
                      </span>
                  </div>
              </div>
              <div>
                  <div class="contact_lxfs_con_l">
                      <span class="span1"><img src="<?php echo $OSS_URL;?>img/kf.png"/></span>
                      <span class="span2">
                          <h3>客服服务</h3>
                          Tel:158 1746 0855&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;0755-33527095<br />
                          QQ:317361652&nbsp;&nbsp;<a href="http://wpa.qq.com/msgrd?v=3&uin=2311339249&site=qq&menu=yes" target="_blank"><img src="<?php echo $OSS_URL;?>img/QQzx.jpg"/></a><br />
                          E-mail:server@szlcnet.com&nbsp;&nbsp;&nbsp;联系人:石小姐
                      </span>
                  </div>
                  <div class="contact_lxfs_con_l float_r">
                      <span class="span1"><img src="<?php echo $OSS_URL;?>img/zp.png"/></span>
                      <span class="span2">
                          <h3>招聘服务</h3>
                          Tel:135 3810 0855&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;0755-33059400<br />
                          QQ:1109186819&nbsp;&nbsp;<a href="http://wpa.qq.com/msgrd?v=3&uin=1109186819&site=qq&menu=yes" target="_blank"><img src="<?php echo $OSS_URL;?>img/QQzx.jpg"/></a><br />
    ...
    <div class="contact">
      <div class="contact_map" id="map" > </div>
        <div class="contact_text">
            ...
            <div class="contacus"> <?php echo $res['basic_content'];?>
                <div class="ewm_model">
                    <P><img  src="<?php echo $OSS_URL;?>img/sao_ewm.jpg" width="150">扫描访问手机站</P>
                    <P style="margin-left:10px;"><img  src="<?php echo $OSS_URL;?>img/sao_wx.jpg" width="150">扫描关注公众号</P>
                </div>
                <p> <br>
                </p>
            </div>
    ...
    function map_init() {
        ...
        for (var i = 0; i < markerArr.length; i++) {
            ...
            info[i] = '<div style="margin:0;line-height:24px;padding:2px;padding-bottom:30px;">' + '<img src="<?php echo $OSS_URL;?>img/mappic.png" alt="" style="float:right;zoom:1;overflow:hidden;width:100px;height:100px;margin-left:3px;"/>' + markerArr[i].address + '<br/><strong>电话：' + markerArr[i].tel + '</strong><br/><strong>附近标志性建筑:</strong>珠江广场、正中时代大厦<br/>线路：' + markerArr[i].gongjiao + '</div>';
            //创建百度样式检索信息窗口对象
