...
<link rel="stylesheet" type="text/css" href="<?php echo $OSS_URL;?>css/component.css"/>
<script src="<?php echo $OSS_URL;?>js/Case.js" type="text/javascript"></script>
</head>
<body>
﻿<header id="header">
  <div class="headDiv">
...
<div class="detail_banner case_ban">
  <div class="twinkling"></div>
</div>
<!--分类浏览-->
<div class="borwser_model">
  <div class="tm_s">
    <h2>分类浏览<span>classification</span></h2>
    <p class="bor_catgory">
      <?php if(is_array($case_Catgory)){foreach($case_Catgory as $key=>$vo){?> <a title="<?php echo $vo['case_sort_name'];?>" href="<?php echo $APP_URL;?>Case/Index/catgoty/<?php echo $vo['alias'];?><?php echo $SUFFIX;?>"><?php echo $vo['case_sort_name'];?></a> <?php } } ?>
    </p>
  </div>
</div>
<section id="grid-wrap" class="grid-wrap">
  <ul class="grid swipe-down" id="grid" style=" display:block; margin:0 auto;">
    <?php if(is_array($list)){foreach($list as $key=>$vo){?>
      <li><a href="<?php echo $APP_URL;?>Case/detail/id/<?php echo $vo['case_id'];?>.html"><img src="<?php echo $OSS_URL;?><?php echo $vo['case_spic'][0];?>" alt="<?php echo $vo['case_name'];?>">
        <h3><?php echo $vo['case_name'];?></h3>
        </a></li>
    <?php } } ?>
  </ul>
</section>
<div class="pagin"> <?php echo $page;?></div>
<script src="<?php echo $OSS_URL;?>js/waterfall/modernizr.custom.js"></script> 
<script src="<?php echo $OSS_URL;?>js/waterfall/masonry.pkgd.min.js"></script> 
<script src="<?php echo $OSS_URL;?>js/waterfall/imagesloaded.pkgd.min.js"></script> 
<script src="<?php echo $OSS_URL;?>js/waterfall/classie.js"></script> 
<script src="<?php echo $OSS_URL;?>js/waterfall/colorfinder-1.1.js"></script> 
<script src="<?php echo $OSS_URL;?>js/waterfall/gridScrollFx.js"></script> 
<script>
