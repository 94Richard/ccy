...
<link rel="stylesheet" href="<?php echo $OSS_URL;?>css/Panorama.css"/>
...
<script src="<?php echo $OSS_URL;?>js/photo-info.js" type="text/javascript"></script>
</head>
<body>
﻿<header id="header">
  <div class="headDiv">
...
<div class="advantage">
  ...
  <ul>
    <li>
      <div class="advantage_img"><img src="<?php echo $OSS_URL;?>img/y_1.jpg"></div>
      <div class="advantage_text">可观看整个场景空间的所有图像<br />
        高清场景<br />
        令细节表现更完美</div>
    </li>
    <li>
      <div class="advantage_img"><img src="<?php echo $OSS_URL;?>img/y_2.jpg"></div>
      <div class="advantage_text">全景播放经过特殊透视处理<br />
        立体感<br />
        沉浸感强烈</div>
    </li>
    <li>
      <div class="advantage_img"><img src="<?php echo $OSS_URL;?>img/y_3.jpg"></div>
      <div class="advantage_text">观看全景时<br />
        观赏者可通过鼠标任意放大缩小<br />
        随意拖动</div>
    </li>
    <li>
      <div class="advantage_img"><img src="<?php echo $OSS_URL;?>img/y_4.jpg"></div>
...
<div class="application">
  <div class="application_center">
    ...
    <ul>
      <li>
        <div class="wrap"><img src="<?php echo $OSS_URL;?>img/11.jpg">
          <div><b></b> <span> <em><a href=""><img src="<?php echo $OSS_URL;?>img/wrap_button.png"></a></em>
            <p>绿地地产室内全景图</p>
            </span> </div>
        </div>
      </li>
      <li>
        <div class="wrap"><img src="<?php echo $OSS_URL;?>img/22.jpg">
          <div><b></b> <span> <em><a href=""><img src="<?php echo $OSS_URL;?>img/wrap_button.png"></a></em>
            <p>保利地产室内全景图</p>
            </span> </div>
        </div>
      ...
      <li>
        <div class="wrap"><img src="<?php echo $OSS_URL;?>img/33.jpg">
          <div><b></b> <span> <em><a href=""><img src="<?php echo $OSS_URL;?>img/wrap_button.png"></a></em>
            <p>华润置地室内全景图</p>
            </span> </div>
        </div>
