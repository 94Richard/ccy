...
<div class="caseimg">
<div class="caseimg-title"><?php echo $case_detail['case_name'];?></div>
<div class="caseimg-text"><?php echo $case_detail['case_content'];?></div>
<ul>
<?php if(is_array($spicArr)){foreach($spicArr as $k=>$vo){?>
                            <li class="demo-image first" data-image="<?php echo $APP_URL;?><?php echo $vo;?>"
                                data-title="<?php echo $case_detail['case_name'];?>" data-caption="<?php echo $case_detail['case_des'];?>"><img
                                    src="<?php echo $APP_URL;?><?php echo $vo;?>"/></li>
                        <?php } } ?>
                        </ul>
</div>
