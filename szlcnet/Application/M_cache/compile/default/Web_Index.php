...
<section class="Contain" style=" padding-top:135px;">
  <div data-height="445" style=" padding-bottom: 271.7px;" class="ServicesBox official_website_bg fast_nav_fixed">
    ...
    <div class="img"> <img src="<?php echo $APP_URL;?>Application/M/Template/default/img/official_website_img.png"> </div>
  </div>
  ...
  <div style="top: 244px;" class="fast_nav">
    <ul>
      <li class="first"> <img src="<?php echo $APP_URL;?>Application/M/Template/default/img/fast_nav_img1_03.png">
        <div class="hover">
          <div class="name">官网建设</div>
          <img src="<?php echo $APP_URL;?>Application/M/Template/default/img/fast_nav_img1_03.png"> </div>
      </li>
      <li> <img src="<?php echo $APP_URL;?>Application/M/Template/default/img/fast_nav_img2_03.png">
        <div class="hover">
          <div class="name">网上商城</div>
          <img src="<?php echo $APP_URL;?>Application/M/Template/default/img/fast_nav_img2_03.png"> </div>
      </li>
      <li> <img src="<?php echo $APP_URL;?>Application/M/Template/default/img/fast_nav_img3_03.png">
        <div class="hover">
          <div class="name">互动营销</div>
          <img src="<?php echo $APP_URL;?>Application/M/Template/default/img/fast_nav_img3_03.png"> </div>
      </li>
      <li> <img src="<?php echo $APP_URL;?>Application/M/Template/default/img/fast_nav_img4_03.png">
        <div class="hover">
          <div class="name">品牌型网站</div>
          <img src="<?php echo $APP_URL;?>Application/M/Template/default/img/fast_nav_img4_03.png"> </div>
      </li>
      <li> <img src="<?php echo $APP_URL;?>Application/M/Template/default/img/fast_nav_img5_03.png">
        <div class="hover">
          <div class="name">行业门户</div>
          <img src="<?php echo $APP_URL;?>Application/M/Template/default/img/fast_nav_img5_03.png"> </div>
      </li>
      <li class="last"> <img src="<?php echo $APP_URL;?>Application/M/Template/default/img/fast_nav_img6_03.png">
        <div class="hover">
          <div class="name">内外信息网</div>
          <img src="<?php echo $APP_URL;?>Application/M/Template/default/img/fast_nav_img6_03.png"> </div>
      </li>
    </ul>
  </div>
</section>
