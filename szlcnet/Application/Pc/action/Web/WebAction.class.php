...
class WebAction extends BaseAction
{
    ...
    public function index()
    {
        ...
        $this->assign("guest_title", "现在开始定制专属于您的网站");
        $this->assign("guest_instructions", "网站建设哪家强，深圳龙岗找创驰云！");
        $this->assign("subject", "网站建设专栏");
        $arr = array(
            'website' => 40,
            'shop' => 41,
            'marketing' => 42,
    ...
    public function scheme()
    {
        ...
        $this->assign("guest_title", "思维无限，创意无限");
        $this->assign("guest_instructions", "现在开始定制专属于您的创意策划！");
