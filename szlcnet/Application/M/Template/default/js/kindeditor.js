var KindReady = function (K) {
	...
	K.themes = {
		...
		'simpleAndUpload': ['source', '|', 'fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold', 'italic', 'underline', 'removeformat', '|', 'justifyleft', 'justifycenter', 'justifyright', 'insertorderedlist', 'insertunorderedlist', '|', 'image', 'multiimage', '|', 'clearhtml', 'quickformat', '|', 'remotefile', 'fullscreen']
	}

	K.lang({ remotefile: '保存远程文件' });
	...
	K.options.allowUpload = true; K.options.uploadJson = '/KindEditor/UploadForKindeditor'; // 设置 upload 插件
	K.options.allowFileManager = true; K.options.fileManagerJson = '/KindEditor/UploadManager'; // 设置 fileManager 插件
	K.options.allowUploadRemoteFile = true; K.options.uploadRemoteFileJson = '/KindEditor/SaveRemoteFile'; // 设置 uploadRemoteFile 插件
	...
	K.options.basePath = '/Scripts/kindeditor/';
	...
	K.options.cssPath = K.options.basePath + 'plugins/code/prettify.css';
