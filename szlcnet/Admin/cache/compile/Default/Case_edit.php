...
<div class="place"><span><i class="glyphicon glyphicon-th-list"></i>&nbsp;位置：</span>
    ...
    <div class="pull-left">
        <ul class="placeul">
            <li><a href="javascript:;">编辑案例 </a></li>
        </ul>
    </div>
    <div class="pull-right">
        <a class="btn btn-primary insetBtn" href="index.php?a=Case&f=add" type="button"><i
...
<div class="formbody">
    ...
    <form method="post" action="index.php?a=Case&f=update" class="ajax_form" id="caseFrom" enctype="multipart/form-data">
        <table cellspacing="1" class="myform">
            <tr>
                ...
                <td><select name="case_one_id" class="form-control selectSubmit">
                    ...
                    <?php if($vo['case_one_id']==$v['case_sort_id']){ ?>selected="selected"<?php } ?>
            ...
            <tr>
                ...
                <td><input type="text" name="case_name" size="25" id="input_alias" value="<?php echo $vo['case_name'];?>"
                           class="form-control"/></td>
            </tr>
            <tr>
                <td align="right">别名：</td>
                <td><input type="text" name="alias" size="25" id="alias" value="<?php echo $vo['alias'];?>" class="form-control"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td width="84%"><textarea name="case_seo_description" cols="40" rows="3"
                                          class="form-control bootstrp_textarea top8" id="case_seo_description"><?php echo $vo['case_seo_description'];?></textarea>
                </td>

            </tr>
            <tr>
                <td width="16%" align="right"><font color="#FF0000">*</font>SEO页面关键词：</td>
                <td width="84%"><textarea name="case_seo_keyword" cols="50" class="form-control bootstrp_textarea top8"
                                          id="case_seo_keyword"><?php echo $vo['case_seo_keyword'];?></textarea></td>
            </tr>
            <tr>
                <td align="right">排 序：</td>
                <td><input type="text" name="case_order" size="25" value="<?php echo $vo['case_order'];?>" class="form-control"/></td>
            </tr>
            <tr>
                <td align="right">推荐：</td>
                <td><input type="radio" name="case_commend" value="1"
                    <?php if($vo['case_commend']==1){ ?>checked<?php } ?>
                    />
                    是 <input name="case_commend" type="radio" value="0"
                    <?php if($vo['case_commend']==0){ ?>checked<?php } ?>
                    />
                    否
                </td>
            </tr>
              ...
              <tr>
                ...
                <td width="84%"><textarea name="case_des" cols="50" class="form-control bootstrp_textarea top8"
                                          id="case_des"><?php echo $vo['case_des'];?></textarea></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="file" name="case_spic_file" id="case_spic_file"
                    ...
                    <input type="hidden" id="case_hidden" value="<?php echo $case_path;?>"
                           name="case_spic"/>

                    <div class="imglist" id="imglist">
                        <?php $i=0; ?>
                        <?php if(is_array($img_url)){foreach($img_url as $key=>$m){?>
                            <ul>
                                <img width="100" height="100" path="<?php echo $m;?>" border="0" src="../<?php echo $m;?>">
                                <span onclick="delimg(this)">删除图片</span>
                                <span class="casefm">设为封面

                                    <?php
                                    if ($i==0){
                                    ?>
                                    <i class="fa fa-check-square fa-3x fmi"></i>
                                    <?php
                                    }
                                   ?>
                                </span>
            ...
            <tr>
                <td align="right"><input type="hidden" name="id" value="<?php echo $vo['case_id'];?>"/>
