...
<div class="formbody">
  ...
  <form method="post" action="index.php?a=Product&f=insert" class="ajax_form">
    <table cellspacing="1" class="myform">
      <tr>
        ...
        <td><select name="product_one_id" class="form-control selectSubmit">
            ...
            <option value="<?php echo $v['product_sort_id'];?>" > <?php echo $v['product_sort_name'];?> </option>
            <?php } } ?>
          </select></td>
      </tr>
      <tr>
...
<input type="hidden" name="<?php echo $file_name;?>" value="<?php echo $img_url;?>" id="hide_file" />
      ...
      <tr>
        ...
        <td><input type="text" name="url" size="25"  class="form-control"/></td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="1"><input type="hidden" name="language" value="<?php echo $_COOKIE[LANG];?>"/>
