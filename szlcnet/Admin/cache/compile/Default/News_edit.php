...
<div class="place"><span><i class="glyphicon glyphicon-th-list"></i>&nbsp;位置：</span>
  ...
  <div class="pull-right">
    <a class="btn btn-primary insetBtn" href="index.php?a=News&f=add" type="button"><i class="fa fa-pencil"></i>&nbsp;&nbsp;新增</a>
  </div>
</div>

<div class="formbody">

  <div class="formtitle"><span>编辑新闻</span></div>

  <form method="post" action="index.php?a=News&f=update"   class="ajax_form">
    <table cellspacing="1" class="myform">
      ...
      <tr>
        ...
        <td><select name="parent_id" class="form-control selectSubmit">
            ...
            <?php if(is_array($list)){foreach($list as $key=>$v){?>
                ...
                <?php if($vo['parent_id']==$v['news_sort_id']){ ?>selected="selected"<?php } ?>
      ...
      <tr>
        ...
        <td  ><input name="news_title" type="text" class="form-control" id="news_title" value="<?php echo $vo['news_title'];?>" size="50" maxlength="100"></td>
      </tr>
...
<input type="hidden" name="<?php echo $file_name;?>" value="<?php echo $img_url;?>" id="hide_file" />
      ...
      <tr>
        ...
        <td ><input name="news_seo_title" type="text" class="form-control" value="<?php echo $vo['news_seo_title'];?>" id="news_seo_title" size="85"></td>
      </tr>
      <tr>
        <td align="right" nowrap >SEO描述：</td>
        <td ><textarea name="news_seo_description" cols="50" class="form-control bootstrp_textarea top8" id="news_seo_description"><?php echo $vo['news_seo_description'];?></textarea></td>
      </tr>
      <tr>
        <td align="right" nowrap >SEO关键词：</td>
        <td ><textarea name="news_seo_keyword" cols="50" class="form-control bootstrp_textarea top8" id="news_seo_keyword"><?php echo $vo['news_seo_keyword'];?></textarea></td>
      </tr>
      <tr>
      <tr>
      ...
      <tr>
        <td align="right"><input type="hidden" name="id" value="<?php echo $vo['news_id'];?>" />
          <input type="hidden" name="name" value="news_id" /></td>
        <td>
          ...
          <button type="button" class="btn btn-primary ajax_btn" data-url="index.php?a=News&f=index">提交</button>
        </td>
      </tr>
    </table>
  </form>
